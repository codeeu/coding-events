...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EventAudience'
        db.delete_table(u'api_eventaudience')

        # Removing M2M table for field audience on 'Event'
        db.delete_table(db.shorten_name(u'api_event_audience'))
    ...
    models = {
        'api.event': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 17, 0, 0)'}),
