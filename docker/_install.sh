...
apt-get -y update
apt-get -u upgrade
apt-get install -y libjpeg-dev python-dev python-setuptools supervisor ruby-sass python-geoip libmysqlclient-dev git texlive-base texlive-latex-base texlive-latex-recommended texlive-full
